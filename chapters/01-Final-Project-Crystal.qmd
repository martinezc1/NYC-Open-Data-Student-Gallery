...
causes_of_death<- read_parquet("data/raw/New_York_City_Leading_Causes_of_Death_data.parquet")
indoor_complaints<- read_parquet("data/raw/Indoor_Environmental_Complaints_data.parquet")
```
...
(@R-tidyverse) (@R-skimr) (@R-readxl) (@R-ggplot2) (@R-knitr) (@R-lubridate) (@R-arrow)
