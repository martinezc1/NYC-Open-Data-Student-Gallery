...
tree_data <- read_parquet("data/raw/2015_Street_Tree_Census.parquet")
animal_data <- read_parquet("data/raw/Urban_Park_Ranger_Animal_Condition_Response.parquet")
```
...
knitr::include_graphics("images/raccoon.png")
```
