...
(@R-tidyverse) (@R-janitor) (@R-ggthemes) (@R-rcompanion) (@R-leaflet) (@R-leaflet.extras)
(@R-leaflet.providers) (@R-htmltools) (@R-knitr) (@R-nycOpenData) (@R-arrow)
```{r}
#| label: packages
#| message: false
#| warning: false
...
restaurant_rating_data <- read_parquet("data/raw/restaurant_rating_data.parquet", show_col_types = FALSE)
```
