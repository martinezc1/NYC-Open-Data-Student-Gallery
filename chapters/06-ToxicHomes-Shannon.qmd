...
(@R-tidyverse) (@R-readxl) (@R-ggplot2) (@R-mosaic) (@R-AICcmodavg) (@R-knitr) (@R-arrow)
...
#| warning: false
#| cache: true
mold_data <- read_parquet("data/raw/311_Service_Requests_from_2010_to_Present_20251215.parquet")
dv_data <- read_parquet("data/rawNYPD_Complaint_Data_Historic_20251218.parquet")
```
